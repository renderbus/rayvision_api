...
latex_documents = [
    (master_doc, 'rayvision_api.tex', u'rayvision_api Documentation',
     u'', 'manual'),
]
...
man_pages = [
    (master_doc, 'rayvision_api', u'rayvision_api Documentation',
     [author], 1)
]
